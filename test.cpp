...
{ // ? variable declaration
    ...
    file.open("results/result" + std::string(argv[1]) + ".dat", std::ios::out); /*create file and open it*/
    fileBench.open("results/result" + std::string(argv[1]) + "Bench.dat", std::ios::out);
    if (my_rank == 0)
    {
